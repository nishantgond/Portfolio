...
const abouts = [
    ...
    aboutMe(
        ...
        'West Bengal, India',
        'Indian',
        'nishantadok1@gmail.com',
        'nishant.gond',
        '+918100336795',
        '',
        'github.com/nishantgond',
        'https://www.linkedin.com/in/nishant-gond-62186a343/',
        'facebook.com/nishantgond',
        'Core Java, HTML, CSS, Javascript, SQL',
...
const certificates = [
    certificate(
        ...
        'Tik-Tac-Toe',
        'tiktactoe',
        'https://nishantgond.github.io/Tic-Tac-Toe/'),

    certificate(
        '09 April 2024',
        'Netflix Clone',
        'netflix',
        'https://nishantgond.github.io/Netflix-Clone/'),

    certificate(
        '08 August 2024',
        'Swiggy Clone',
        'swiggy',
        'https://nishantgond.github.io/Swiggy-Clone/'),

    certificate(
        '15 Sept 2024',
        'Tesla Clone',
        'tesla',
        'https://nishantgond.github.io/Tesla-Clone/'),

    certificate(
        '15 November 2024',
        'Login Page',
        'loginpage',
        'https://nishantgond.github.io/Login-page/'),
]
/* Certificates End */
